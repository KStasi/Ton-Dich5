...
./lite-client/lite-client -C ./lite-client/ton-global.config -c 'sendfile ./build/main-wallet-query.boc'
sleep 2
...
./lite-client/lite-client -C ./lite-client/ton-global.config -c 'sendfile ./build/new-wallet-00-query.boc'
./lite-client/lite-client -C ./lite-client/ton-global.config -c 'sendfile ./build/new-wallet-01-query.boc'
./lite-client/lite-client -C ./lite-client/ton-global.config -c 'sendfile ./build/new-wallet-02-query.boc'
./lite-client/lite-client -C ./lite-client/ton-global.config -c 'sendfile ./build/new-wallet-03-query.boc'
./lite-client/lite-client -C ./lite-client/ton-global.config -c 'sendfile ./build/new-wallet-04-query.boc'
./lite-client/lite-client -C ./lite-client/ton-global.config -c 'sendfile ./build/new-wallet-05-query.boc'
./lite-client/lite-client -C ./lite-client/ton-global.config -c 'sendfile ./build/new-wallet-06-query.boc'
./lite-client/lite-client -C ./lite-client/ton-global.config -c 'sendfile ./build/new-wallet-07-query.boc' 